...
<head>
    ...
    <title>Partie grane białymi</title>
...
<div class="container">
    <div class="card card-login mx-auto mt-5">
        <div class="card-header">Statystyka dla partii granych kolorem białym</div>
        <div class="card-body">


            <h3>Pokaż mi jakie mam wyniki w danym wariancie</h3>
            <form:form method="post" modelAttribute="gameDto">
